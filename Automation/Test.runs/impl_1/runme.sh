...
HD_PWD='/home/ganesh/IC_design/Scripting/Vivado/Automation/Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_W_2R1_Reg_file.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_W_2R1_Reg_file.tcl -notrace
