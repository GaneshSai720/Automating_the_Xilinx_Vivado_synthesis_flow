...
HD_PWD='/home/ganesh/IC_design/Scripting/Vivado/Automation/Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_W_2R1_Reg_file.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_W_2R1_Reg_file.tcl
